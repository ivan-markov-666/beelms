...
const container_name_resolver_1 = require("../docker-compose/container-name-resolver");
...
class DockerComposeEnvironment {
    ...
    up(services) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { dockerComposeClient } = yield (0, docker_client_1.getDockerClient)();
            yield (0, reaper_1.registerComposeProjectForCleanup)(this.projectName);
            const options = {
            ...
            if (this.pullPolicy.shouldPull()) {
                yield dockerComposeClient.pull(options, services);
            }
            yield dockerComposeClient.up(Object.assign(Object.assign({}, options), { commandOptions,
                composeOptions, environment: this.environment }), services);
            ...
            const startedGenericContainers = (yield Promise.all(startedContainers.map((startedContainer) => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    try {
                        yield dockerComposeClient.down(options, { removeVolumes: true, timeout: 0 });
                    }
                    catch (_a) {
