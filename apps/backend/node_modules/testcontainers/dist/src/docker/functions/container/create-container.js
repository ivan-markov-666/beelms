...
const createContainer = (sessionId, options) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
        ...
        const container = yield dockerode.createContainer({
            ...
            Labels: (0, create_labels_1.createLabels)(sessionId, options.reusable, options.labels),
