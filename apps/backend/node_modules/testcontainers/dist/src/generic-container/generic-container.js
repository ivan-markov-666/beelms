...
class GenericContainer {
    ...
    start() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, pull_image_1.pullImage)(dockerClient.dockerode, dockerClient.info.dockerInfo.indexServerAddress, {
    ...
    reuseOrStartContainer(dockerClient) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    reuseContainer(dockerClient, container) {
        return __awaiter(this, void 0, void 0, function* () {
            const inspectResult = yield (0, inspect_container_1.inspectContainer)(container);
            const boundPorts = bound_ports_1.BoundPorts.fromInspectResult(dockerClient.hostIps, inspectResult).filter(this.opts.exposedPorts);
            ...
            const startedContainer = new started_generic_container_1.StartedGenericContainer(container, dockerClient.host, inspectResult, boundPorts, inspectResult.name, this.waitStrategy);
    ...
    startContainer(dockerClient, createContainerOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            const container = yield (0, create_container_1.createContainer)(dockerClient.sessionId, createContainerOptions);
            if (!this.opts.imageName.isHelperContainer() && port_forwarder_1.PortForwarderInstance.isRunning()) {
                yield this.connectContainerToPortForwarder(container);
            }
            ...
            if (this.filesToCopy.length > 0 || this.directoriesToCopy.length > 0 || this.contentsToCopy.length > 0) {
                ...
                archive.finalize();
                yield (0, put_container_archive_1.putContainerArchive)({ container, stream: archive, containerPath: "/" });
            }
            ...
            if (logger_1.containerLog.enabled() || this.logConsumer !== undefined) {
                if (this.logConsumer !== undefined) {
                    this.logConsumer(yield (0, container_logs_1.containerLogs)(container));
                }
    ...
    connectContainerToPortForwarder(container) {
        return __awaiter(this, void 0, void 0, function* () {
            const portForwarder = yield port_forwarder_1.PortForwarderInstance.getInstance();
    ...
    withResourcesQuota({ memory, cpu }) {
        this.opts.resourcesQuota = {
            memory: memory !== undefined ? memory * Math.pow(1024, 3) : undefined,
            cpu: cpu !== undefined ? cpu * Math.pow(10, 9) : undefined,
        };
        return this;
    }
