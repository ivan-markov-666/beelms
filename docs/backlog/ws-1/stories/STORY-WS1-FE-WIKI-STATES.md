...
## Dev Tasks
- [ ] Имплементиране на loading/empty/error състояния за `/wiki` според UX/flows.
- [ ] Имплементиране на loading/error/404 състояния за `/wiki/[slug]` според UX/flows.
- [ ] Използване на съществуващи/базови UI компоненти за съобщения (alerts, текстови блокове) от design system-а.
- [ ] Ръчно тестване на сценариите: нормален load, празен списък, симулирана грешка от API, 404 slug.
- [ ] (по избор) Автоматизирани тестове за рендване на различните състояния (snapshot/DOM проверки).
