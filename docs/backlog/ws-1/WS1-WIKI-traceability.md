...
| FR-WIKI-4 | Превключване на език при налични езикови версии                  | EPIC-WIKI-PUBLIC, EPIC-CROSS-I18N; базов WS1-FE   | –                                                                                                                                                                     | STORY-MVP-WIKI-LANGUAGE-SWITCH                     | Първият WS-1 vertical може да е на фиксиран BG; това story добавя пълното поведение. |
