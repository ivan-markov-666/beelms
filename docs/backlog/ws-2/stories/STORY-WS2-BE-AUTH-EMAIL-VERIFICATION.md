...
## Dev Tasks
- [ ] Дизайн на модел за състояние на имейла (`verified`, pending verification, токени, срок на валидност).
- [ ] Добавяне на нужните полета към `User` и/или отделна таблица за verification токени.
- [ ] BE endpoints за:
...
- [ ] Интеграция с имейл услугата (изпращане на имейли с линк за потвърждение).
- [ ] Unit тестове за логиката за създаване/валидиране/изтичане на токени.
- [ ] Интеграционни тестове за регистрация + verify, смяна на имейл + verify.
