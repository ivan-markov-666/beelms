...
| FR-API-DEMO-1 (FR-API-DEMO) | Training API с Swagger/OpenAPI, базови ping/echo endpoints за API/integration упражнения           | EPIC-PRACTICE-API-DEMO; EPIC-WS3-PRACTICAL-API-DEMO | EPIC-WS3-PRACTICAL-API-DEMO; STORY-WS3-BE-TRAINING-API-MINIMAL; STORY-WS3-BE-TRAINING-API-SWAGGER; STORY-WS3-FE-TRAINING-API-INTRO | WS-3 Training API skeleton – планиран (epic + BE/FE stories дефинирани, предстои имплементация). |
