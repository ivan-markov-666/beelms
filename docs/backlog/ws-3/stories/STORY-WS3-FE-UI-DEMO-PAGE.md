...
## Dev Tasks
- [ ] Дефиниране на route (напр. `/practice/ui-demo`) в Next.js приложението.
- [ ] Имплементация на UI с подбрани HTML/React компоненти според PRD/MVP изискванията.
- [ ] Имплементация на reset логика, която връща UI в начално състояние без page reload.
- [ ] Интеграция с главния layout и навигация (линк в header/nav към UI Demo страницата).
- [ ] FE тестове (React Testing Library или екв.) за основните поведения (рендер, взаимодействие, reset).
