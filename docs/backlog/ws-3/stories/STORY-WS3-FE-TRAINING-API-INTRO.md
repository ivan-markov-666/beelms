...
## Dev Tasks
- [x] Дефиниране на route (напр. `/practice/api-demo`) в Next.js приложението.
- [x] Имплементация на копирайт/структура според UX документа (заглавия, секции, списък със сценарии).
- [x] Добавяне на бутон/линк към Swagger UI на Training API.
- [x] Интеграция с основното навигационно меню.
- [x] FE тест, който проверява, че страницата се рендерира и линкът към Swagger има очаквания href.
