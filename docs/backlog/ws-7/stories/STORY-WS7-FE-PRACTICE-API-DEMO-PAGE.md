...
## Dev Tasks
- [ ] Дефиниране на route `/practice/api-demo` в FE и включването му в навигацията (напр. под секция "Practice").
- [ ] Имплементация на статично/полустатично съдържание, което описва Training API и показва примерни заявки.
- [ ] (По избор) Добавяне на интерактивни елементи (бутон за ping, форма за echo) и wiring към реалния Training API.
- [ ] Линк към Swagger UI / API документацията, ако е налична.
- [ ] FE тестове за рендер на основните секции и линкове.
