...
> приложения и инстанции, стъпили върху beelms core, имат собствени продуктови документи извън този репозитори.
...
- **Feature toggles (конфигурируеми опции)**
  ...
  - Централизирано управление на всеки социален login (Google, Facebook, GitHub, LinkedIn) – администраторът може да активира/деактивира отделните интеграции според инциденти, политики или договори. Когато даден login е изключен, нови опити за вход се блокират, но съществуващите акаунти остават активни и системата предлага fallback (имейл/парола).
...
Следните функционалности са извън обхвата на MVP (v1):

- Вписване/регистрация чрез външни identity providers (напр. Google/Facebook/LinkedIn/Git акаунт).
