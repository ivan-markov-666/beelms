...
> Бележка: Този PRD описва **beelms core** като рамка. Конкретни инстанции (напр. QA4Free), стъпили върху нея, имат собствени Product Brief и PRD в отделни репозитории.
...
Тук са описани основните функционални области на beelms core. Детайлизираното поведение по екрани и UX сценарии за конкретни инстанции (като QA4Free) се държи в техните собствени MVP feature list / архитектурни документи.
