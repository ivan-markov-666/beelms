...
- FR-ADMIN-4: Админ табло показва базови метрики (брой регистрирани потребители, най-преглеждани Wiki страници). В текущото MVP не се показват и не се събират метрики за брой изпълнени практичeски задачи – те се отлагат за бъдещия „exams“ модул.
