...
inputDocuments:
  ...
  - docs/product/prd.md
  - docs/backlog/brainstorm-beelms-core.md
...
- служи като отправна точка за конкретни продукти (QA4Free и др.);
...
- **Регистриран потребител (учещ се)**
  - Нужди: достъп до записаните курсове, ясен прогрес, базово взаимодействие с практическата среда.
...
- **Practical Lab** – линк към демо UI и Training API документация (ако са активни).
...
### 5.6. Практическа среда – UI Demo

- Страница с множество UI елементи, групирани по раздели (Form Elements, Buttons, Tables, Notifications).
- Sidebar или top tabs за избиране на „scenarios".
- Видим текст, описващ упражненията за QA.
- Action „Reset" за връщане към начално състояние.

### 5.7. Практическа среда – API Demo

- Swagger UI страница (вграден или линк), достъпна от навигацията „Practical Lab".
- Кратко интро как да се използват API endpoints за упражнения.
...
Тази UX спецификация служи като основа – конкретни инстанции (QA4Free и др.) могат да стъпват върху нея и да добавят свои уникални UX решения, без да нарушават общия модел за навигация, роли и потоци.
