...
- **Task 1.2.2: Конфигуриране на TypeORM и Миграции**
  ...
  - [ ] **Test**: Добавяне на стъпка в CI pipeline, която стартира празна база данни и изпълнява `migration:run`, за да се валидира, че миграциите са синтактично коректни. Добавяне на теста към Regression Suite пакета.
  - **Документация:**
