...
- Name: Auth API >> should return error for invalid credentials
- Location: D:\courses\my\QA\project\be\qa-4-free\services\auth\tests\api\auth\auth.spec.ts:134:7
...
Expected: 200
Received: 401
    at D:\courses\my\QA\project\be\qa-4-free\services\auth\tests\api\auth\auth.spec.ts:142:31
```
