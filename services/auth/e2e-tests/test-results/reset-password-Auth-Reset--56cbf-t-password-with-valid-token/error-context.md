...
- Name: Auth Reset Password API >> should reset password with valid token
- Location: D:\courses\my\QA\project\be\qa-4-free\services\auth\e2e-tests\tests\reset-password.spec.ts:8:7
...
Call log:
  - → POST http://localhost:3001/auth/reset-password
    ...
    at D:\courses\my\QA\project\be\qa-4-free\services\auth\e2e-tests\tests\reset-password.spec.ts:17:36
```
