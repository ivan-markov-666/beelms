...
- Name: Auth Profile API >> should return 401 when using invalid token
- Location: D:\courses\my\QA\project\be\qa-4-free\services\auth\e2e-tests\tests\profile.spec.ts:48:7
...
Call log:
  - → GET http://localhost:3001/auth/profile
    ...
    at D:\courses\my\QA\project\be\qa-4-free\services\auth\e2e-tests\tests\profile.spec.ts:49:36
```
