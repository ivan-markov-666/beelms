...
- Name: Auth Logout API >> should logout a user successfully
- Location: D:\courses\my\QA\project\be\qa-4-free\services\auth\e2e-tests\tests\logout.spec.ts:16:7
...
Call log:
  - → POST http://localhost:3001/auth/register
    ...
    at D:\courses\my\QA\project\be\qa-4-free\services\auth\e2e-tests\tests\logout.spec.ts:18:51
```
