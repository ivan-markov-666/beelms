...
- Name: Auth Login API >> should login a user successfully
- Location: D:\courses\my\QA\project\be\qa-4-free\services\auth\e2e-tests\tests\login.spec.ts:5:7
...
Call log:
  - → POST http://localhost:3001/auth/register
    ...
    at D:\courses\my\QA\project\be\qa-4-free\services\auth\e2e-tests\tests\login.spec.ts:7:54
```
