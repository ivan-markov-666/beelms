...
- Name: Auth Register API >> should return error when registering with invalid data
- Location: D:\courses\my\QA\project\be\qa-4-free\services\auth\e2e-tests\tests\register.spec.ts:33:7
...
Call log:
  - → POST http://localhost:3001/auth/register
    ...
    at D:\courses\my\QA\project\be\qa-4-free\services\auth\e2e-tests\tests\register.spec.ts:35:36
```
