...
- Name: Auth Profile API >> should get user profile when authenticated
- Location: D:\courses\my\QA\project\be\qa-4-free\services\auth\e2e-tests\tests\profile.spec.ts:18:7
...
Call log:
  - → POST http://localhost:3001/auth/register
    ...
    at D:\courses\my\QA\project\be\qa-4-free\services\auth\e2e-tests\tests\profile.spec.ts:20:51
```
