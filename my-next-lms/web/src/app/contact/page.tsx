export default function ContactPage() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-10 text-sm text-gray-700">
      ...
      <p className="mb-3">
        Тази страница е за контакт с екипа зад QA4Free. В текущата MVP версия
        тук може да има само кратка информация и примерни канали за обратна
        връзка, като имейл или линк към GitHub репото.
      </p>
      <p>
